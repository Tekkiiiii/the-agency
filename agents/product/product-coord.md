...
2. Set up scratch at `~/.claude/agents/product/scratch/coords/dc-{name}-scratch.md`
...
Set up at `~/.claude/agents/product/scratch/coords/dc-{name}-scratch.md`:
...
- Department state: `~/.claude/agents/product/state/`
