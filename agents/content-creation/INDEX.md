...
See [Content Request Protocol](../runbooks/content-request-protocol.md) — the full step-by-step workflow from PD request → Marketing brief → Content Creation production → Marketing distribution → feedback loop.
