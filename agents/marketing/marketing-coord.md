...
2. Set up scratch at `~/.claude/agents/marketing/scratch/coords/dc-{name}-scratch.md`
...
Set up at `~/.claude/agents/marketing/scratch/coords/dc-{name}-scratch.md`:
...
- Department state: `~/.claude/agents/marketing/state/`
