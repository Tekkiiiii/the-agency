...
- `tech-writer` — Technical documentation and developer experience writing
- `tech-stack` — Tech stack evaluation and recommendation
- `supabase-sql` — Supabase schema, RLS policies, and SQL patterns
- `copywriting` — Clear, concise technical copy
