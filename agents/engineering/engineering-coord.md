...
2. Set up scratch at `~/.claude/agents/engineering/scratch/coords/dc-{name}-scratch.md`
...
Set up at `~/.claude/agents/engineering/scratch/coords/dc-{name}-scratch.md`:
...
- Department state: `~/.claude/agents/engineering/state/`
