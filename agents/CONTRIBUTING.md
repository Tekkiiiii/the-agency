...
- [Department Assignment Guidelines](#department-assignment-guidelines)
...
- [ ] Agent is in the correct department directory
- [ ] Frontmatter includes correct `department:`, `role:`, and `reports_to:` fields
```
