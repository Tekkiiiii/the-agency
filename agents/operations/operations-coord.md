...
2. Set up scratch at `~/.claude/agents/operations/scratch/coords/dc-{name}-scratch.md`
...
Set up at `~/.claude/agents/operations/scratch/coords/dc-{name}-scratch.md`:
...
- Department state: `~/.claude/agents/operations/state/`
