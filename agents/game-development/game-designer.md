...
- **tech-stack** — Applies game engine and platform expertise to design implementation plans
- **superpowers-test-driven-development** — Uses TDD methodology to validate gameplay systems and game mechanics
- **copywriting** — Authors game design documents, mechanics specifications, and onboarding content
