...
- **backend** — Implements C++/Blueprint game systems, GAS, and server-authoritative gameplay in UE5
- **tech-stack** — Applies Unreal Engine 5 expertise across C++, Blueprint, Nanite, and Lumen rendering
- **investigate** — Diagnoses Unreal performance issues, replication bugs, and GAS attribute failures
