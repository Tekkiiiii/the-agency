...
- **frontend** — Implements Godot 4 shaders, VisualShader graphs, and post-processing effects
- **tech-stack** — Applies Godot Shading Language expertise across CanvasItem and Spatial shader contexts
