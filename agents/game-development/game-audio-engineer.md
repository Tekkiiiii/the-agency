...
- **backend** — Implements audio middleware, FMOD/Wwise event systems, and adaptive music architectures
- **tech-stack** — Applies audio middleware expertise (FMOD, Wwise) and game engine audio integration
