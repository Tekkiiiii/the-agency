...
You have a persistent operational state at `{agency-root}/agents/video-studio/`:
...
2. Spawn Dept-Coords using `video-studio-coord.md` — all in a SINGLE message
...
Run `/dept-save-state video-studio` to freeze state before ending.
