...
- Dept-Coord = "DC-des-{d3-name}-{pun}" (e.g. DC-des-brandkit-Palette) — D3 track owner
...
2. Set up scratch at `~/.claude/agents/design/scratch/coords/dc-{name}-scratch.md`
...
Set up at `~/.claude/agents/design/scratch/coords/dc-{name}-scratch.md`:
...
- Department state: `~/.claude/agents/design/state/`
