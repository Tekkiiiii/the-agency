...
2. Set up scratch at `~/.claude/agents/testing/scratch/coords/dc-{name}-scratch.md`
...
Set up at `~/.claude/agents/testing/scratch/coords/dc-{name}-scratch.md`:
...
- Department state: `~/.claude/agents/testing/state/`
