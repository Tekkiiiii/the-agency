...
description: One-shot implementation unit — LITE variant. Receives exactly one smallest task from Coord-lite or Mini-Coord, executes it, reports DONE/BLOCKED/ESCALATE. No Approach Gate, no 50% Check-In. Phase A QA gate included. Never spawns agents below this level.
...
- STANDARD task-executor: `~/.claude/agents/specialized/task-executor.md`
